...
class Classifier: BasePredictor {
    ...
    override func processObservations(for request: VNRequest, error: Error?) {
        ...
        let result = YOLOResult(orig_shape: inputSize, boxes: [],probs: probs, speed: self.t2, fps: 1 / self.t4, names: labels)
    ...
    override func predictOnImage(image: CIImage) -> YOLOResult {
        ...
        var result = YOLOResult(orig_shape: inputSize, boxes: [], probs:probs, speed: t1, names: labels)
