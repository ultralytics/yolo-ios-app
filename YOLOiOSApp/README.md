...
- **Multiple AI Models:** Use the bundled YOLO26n ('nano') models for all seven tasks immediately after build, then download larger `s/m/l/x` variants on demand for higher accuracy. Custom Core ML models, and opt-in Core AI models on iOS 27 and later devices, are supported too.
