    ...
    public static func create(
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            do {
                ...
                guard let userDefined = mlModel.modelDescription
                    .metadata[MLModelMetadataKey.creatorDefinedKey] as? [String: String] else {
                ...
                if let labelsData = userDefined["classes"] {
                    ...
                    throw NSError(domain: "BasePredictor", code: -1, userInfo: [
                ...
                predictor.visionRequest = {
                    let request = VNCoreMLRequest(model: predictor.detector, completionHandler: {
