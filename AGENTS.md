...
2. **Search and reuse first**: Search the whole repository before creating a feature, component, helper, view, or utility. Reuse or adapt what exists, consolidate in the shared owner when duplication appears, and delete duplicate paths. Three similar lines beat a helper nobody else calls.
