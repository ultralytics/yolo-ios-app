...
class ObjectDetector: Predictor {
    ...
    private weak var currentOnResultsListener: ResultsListener?
    private weak var currentOnInferenceTimeListener: InferenceTimeListener?
    private weak var currentOnFpsRateListener: FpsRateListener?
