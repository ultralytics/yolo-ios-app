...
//                    let xywhn = person.box
//                    let xywh = VNImageRectForNormalizedRect(xywhn, Int(inputSize.width), Int(inputSize.height))
//                    let conf = person.score
//                    boxes.append(Box(index: 0, cls: "person", conf: conf, xywh: xywh, xywhn: xywhn))
