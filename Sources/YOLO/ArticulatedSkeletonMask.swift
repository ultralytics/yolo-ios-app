...
public class ArticulatedSkeletonMask: SkeletonMask {
  ...
  private func addArticulatedSkeletonToScene(
    ...
    addTorsoComponents(
      to: skeletonRoot, positions: positions, confs: confs, confThreshold: confThreshold)
  ...
  private func addTorsoComponents(
    ...
    if let bodyTexture = textures.body,
      confs[K.leftShoulder.rawValue] >= confThreshold
        || confs[K.rightShoulder.rawValue] >= confThreshold
    {
